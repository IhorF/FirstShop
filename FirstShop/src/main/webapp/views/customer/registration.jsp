...
<div><h3 style="text-align: center; padding-top: 2%;">Customer registration</h3></div>
	...
	<sf:form modelAttribute="customer" action="saveCustomer" method="post">
		...
		<br>
		<div style="width: 95px; margin: auto;"><button style="height: 35px; width: 95px; " ><a>register</a></button></div>
